    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Overall", route: "/power/overall" },
          { label: "Awali", route: "/power/awali" },
          { label: "Refinery", route: "/power/refinery" },
          { label: "UOB", route: "/power/uob" },
        ],
      },
      {
        icon: (
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const [pageName, setPageName] = useLocalStorage("selectedMenu", "/power/overall");
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center gap-3 px-6 py-5.5 lg:py-6.5 xl:py-10">
        <div>
            <h2 className="mb-0.5 text-heading-5 font-bold text-dark dark:text-white">
              Dashboard
            </h2>
            <p className="font-medium">Bapco solar system</p>
          </div>
