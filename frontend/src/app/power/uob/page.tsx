...
import { fetchUOBPowerGenerationData } from "../../../../api/power";
...
const UOBPowerGeneration = () => {
  ...
  const [chartData, setChartData] = useState<{
    ...
    labels: [],
    datasets: [],
    title: "UOB Power Generation Forecast",
    tooltipSuffix: " kWh"
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await fetchUOBPowerGenerationData();
        setPowerData(data);
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="UOB Power Generation" />
...
export default UOBPowerGeneration;
