...
import { fetchRefineryPowerGenerationData } from "../../../../api/power";
...
const RefineryPowerGeneration = () => {
  ...
  const [chartData, setChartData] = useState<{
    ...
    labels: [],
    datasets: [],
    title: "Refinery Power Generation Forecast",
    tooltipSuffix: " kWh"
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await fetchRefineryPowerGenerationData();
        setPowerData(data);
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Refinery Power Generation" />
...
export default RefineryPowerGeneration;
